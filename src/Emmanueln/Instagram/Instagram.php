 ...
 * @since 25.08.2016
 * @copyright Emmanuel Ikechukwu N
 * @version 1.0
...
class Instagram
{
    ...
    {
        return $this->_makeCall('users/self/follows', true);
    }
    ...
    {
        return $this->_makeCall('users/self/followed-by', true);
    }
     ...
     * @return mixed
     */
    public function getUserFollowRequest()
    {
